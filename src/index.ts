...
// const localFilName = '2025-01-31_12-21-53_debug' // This one is BEFORE PLAT-998 PR. jez25
// const localFilName = '2025-02-03_10-39-03_debug' // This one is BEFORE PLAT-998 PR. jez28
...
if (cliInputFilePath) {
  ...
  inputFilePath = `./test/logs/${localFilName}.log`;
...
// console.log({ results })
await fs.promises.writeFile(`./test/analytics/${inputFileName}.json`, JSON.stringify(results, null, 2));
// Read analytics file and format date values
const analytics = JSON.parse(
    await fs.promises.readFile(`./test/analytics/${inputFileName}.json`, 'utf8'),
